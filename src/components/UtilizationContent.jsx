...
export function DetailedUtilizationContent() {
  ...
  return (
    <div className="flex flex-col h-full px-6 pt-4">
      ...
      {/* IO */}
      <div className="h-[70px] mt-5">
        <p className="text-sm text-gray-500 mb-1">I/O</p>
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data}>
            <YAxis hide />
            <XAxis dataKey="name" hide />
      ...
      {/* DISK */}
      <div className="h-[70px] mt-5">
        <p className="text-sm text-gray-500 mb-1">DISK</p>
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data}>
            <YAxis hide />
            <XAxis dataKey="name" hide />
      ...
      <div className="mt-auto pt-4 pb-2">
        <h1 className="text-[42px] font-bold text-accent leading-none">
          39<span className="text-lg">%</span>
          <span className="text-sm font-medium ml-2">Overall</span>
        </h1>
      </div>
